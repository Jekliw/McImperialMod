...
package net.mcreator.imperial.potion;
...
import net.mcreator.imperial.procedures.RadiationEffectStartedappliedProcedure;
...
public class RadiationPotionEffect {
	@ObjectHolder("imperial:radiation")
	...
	public static class EffectCustom extends Effect {
		...
		public EffectCustom() {
			...
			potionIcon = new ResourceLocation("imperial:textures/potion.png");
		}
