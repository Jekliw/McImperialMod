...
public class StaloweShovelItem extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_shovel")
	public static final Item block = null;
	public StaloweShovelItem(ImperialModElements instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("stalowe_shovel"));
	}
}
