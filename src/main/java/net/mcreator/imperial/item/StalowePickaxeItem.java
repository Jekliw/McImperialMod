...
public class StalowePickaxeItem extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_pickaxe")
	public static final Item block = null;
	public StalowePickaxeItem(ImperialModElements instance) {
		super(instance, 21);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("stalowe_pickaxe"));
	}
}
