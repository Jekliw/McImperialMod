...
public class StaloweFenceBlock extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_fence")
	public static final Block block = null;
	public StaloweFenceBlock(ImperialModElements instance) {
		super(instance, 7);
	}
