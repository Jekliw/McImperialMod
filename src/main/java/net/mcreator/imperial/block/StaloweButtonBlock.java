...
public class StaloweButtonBlock extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_button")
	public static final Block block = null;
	public StaloweButtonBlock(ImperialModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("stalowe_button");
		}
