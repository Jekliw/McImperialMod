...
public class StaloweWoodBlock extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_wood")
	public static final Block block = null;
	public StaloweWoodBlock(ImperialModElements instance) {
		super(instance, 1);
	}
