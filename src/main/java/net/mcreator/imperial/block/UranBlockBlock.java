...
public class UranBlockBlock extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:uran_block")
	public static final Block block = null;
	public UranBlockBlock(ImperialModElements instance) {
		super(instance, 35);
	}
