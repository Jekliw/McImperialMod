...
public class StaloweLogBlock extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_log")
	public static final Block block = null;
	public StaloweLogBlock(ImperialModElements instance) {
		super(instance, 2);
	}
