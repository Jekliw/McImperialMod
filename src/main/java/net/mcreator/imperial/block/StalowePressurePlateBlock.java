...
public class StalowePressurePlateBlock extends ImperialModElements.ModElement {
	@ObjectHolder("imperial:stalowe_pressure_plate")
	public static final Block block = null;
	public StalowePressurePlateBlock(ImperialModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("stalowe_pressure_plate");
		}
